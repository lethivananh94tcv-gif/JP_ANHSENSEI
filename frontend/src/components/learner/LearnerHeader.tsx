...
import { BookOpen, Languages, PenTool, Flame, Bot, Home, User, LogOut, Shield, Menu, X, ChevronDown } from "lucide-react";
    ...
    <header className="sticky top-0 z-50 w-full bg-[#FFFDF9]/90 backdrop-blur-md border-b border-[#DED3C8] shadow-xs select-none">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-3 group">
          <div className="w-10 h-10 rounded-2xl bg-gradient-to-tr from-[#8B6F5A] to-[#C65D4B] text-white font-serif font-black text-xl flex items-center justify-center shadow-md shadow-[#C65D4B]/20 group-hover:scale-105 transition-transform duration-300">
            学
          </div>
          <div className="flex flex-col">
            ...
            <span className="text-[9px] font-bold tracking-widest uppercase text-[#C65D4B]">
              日本語学習 • JLPT N5-N3
            </span>
          </div>
        </Link>
